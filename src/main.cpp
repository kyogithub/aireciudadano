...
unsigned int measurements_loop_duration = 2000; // 10 seconds
...
{ // Read CO2, temperature and humidity values
  ...
  struct sps_values valu;
  // loop to get data
  do
  {
    ret = sps30.GetValues(&valu);
  ...
  Serial.print(valu.MassPM1);
  Serial.print(F("\t"));
  Serial.print(valu.MassPM2);
  Serial.print(F("\t"));
  Serial.print(valu.MassPM4);
  Serial.print(F("\t"));
  Serial.print(valu.MassPM10);
  Serial.print(F("\t"));
  Serial.print(valu.NumPM0);
  Serial.print(F("\t"));
  Serial.print(valu.NumPM1);
  Serial.print(F("\t"));
  Serial.print(valu.NumPM2);
  Serial.print(F("\t"));
  Serial.print(valu.NumPM4);
  Serial.print(F("\t"));
  Serial.print(valu.NumPM10);
  Serial.print(F("\t"));
  Serial.print(valu.PartSize);
  Serial.print(F("\n"));

  CO2ppm_value = valu.MassPM2;
  temperature = 0;
  humidity = 0;
